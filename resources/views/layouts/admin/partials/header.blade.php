    ...
    <div class="header-container container-xxl">
        ...
        <div
            ...
            <h1 class="d-flex flex-column text-dark fw-bolder my-1">
                <span class="text-white fs-1">{{ GeneralHelper::titleName(url()->current()) }}</span>
                ...
                <div class="me-3">
                    @auth
                        <a href="#" class="btn btn-icon btn-custom btn-active-color-primary" data-kt-menu-trigger="click"
                            ...
                            <!--begin::Svg Icon | path: icons/duotune/communication/com013.svg--> <span
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                            ...
                            <!--end::Menu separator-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5"> <a href="../../demo9/dist/account/overview.html"
