    ...
    <div class="header-container container-xxl">
        ...
        <div class="d-flex align-items-center flex-wrap">
            <div class="header-search py-3 py-lg-0">
                <div id="kt_header_search" class="d-flex align-items-center show menu-dropdown"
            ...
            <div class="me-3">
                <a href="#" class="btn btn-icon btn-custom btn-active-color-primary position-relative"
                    ...
                    <span
                        class="bullet bullet-dot bg-success h-15px w-15px position-absolute translate-middle top-0 start-100 text-white"><span
                            style="font-size: 10px; display:block">{{ GeneralHelper::getCountCart() }}</span></span>
                </a>
                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true"
                    style="">
                    <div class="d-flex flex-column bgi-no-repeat rounded-top"
                        style="background-image:url({{ asset('assets/admin/media/misc/pattern-1.jpg') }})">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <tbody>
                                            @forelse (GeneralHelper::getCart() as $item)
                                                <tr>
                                                    <td>
                                                        <img src="{{ $item->buku->image }}" class="w-50px ms-n1"
                                                            alt="">
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="#"
                                                        ...
                                                        <span
                                                            ...
                                                            Code: {{ $item->buku->code }}</span>
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="text-gray-800 fw-bolder d-block fs-6 ps-0 text-end">{{ $item->total }}</span>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                            ...
                            @if (GeneralHelper::getCountCart() > 0)
                                <div class="py-3 text-center border-top">
                                    <a href="{{ route('cart.index') }}"
                                        class="btn btn-color-gray-600 btn-active-color-primary"> Check Out Peminjaman
