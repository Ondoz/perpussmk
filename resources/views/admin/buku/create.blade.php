<div class="modal fade bd-example-modal-lg" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content">
            ...
            <form class="form" action="{{route('admin.buku.store')}}" id="kt_modal_add_customer_form" enctype="multipart/form-data" method="post">
                ...
                <div class="modal-header" id="kt_modal_add_customer_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Tambah Buku</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input required type="text" class="form-control form-control-solid" name="judul" placeholder="Judul" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required type="text" class="form-control form-control-solid" name="penulis" placeholder="Penulis" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required type="date" class="form-control form-control-solid" name="tgl_rilis" placeholder="Tanggal Rilis" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required type="input" class="form-control form-control-solid" name="bahasa" placeholder="Bahasa" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required type="input" class="form-control form-control-solid" name="negara" placeholder="Negara" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required type="number" class="form-control form-control-solid" name="jumlah_halaman" placeholder="Jumlah Halaman" />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <div class="col">
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required type="number" class="form-control form-control-solid" name="jumlah_buku" placeholder="Jumlah Buku" />
                                    <!--end::Input-->
                                </div>
                            </div>
                        </div>
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input required type="text" class="form-control form-control-solid" name="penerbit" placeholder="Penerbit" />
                            <!--end::Input-->
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea required cols="30" rows="10" class="form-control form-control-solid" name="description" placeholder="Description"></textarea>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
