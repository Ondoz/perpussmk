                ...
                <div class="modal-body">
                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0" id="tableItem">
                        ...
                        <tbody class="item-details" id="tableAppend">
                            <tr>
                                <td><input type="number" class="form-control text-center qtyTotal-1" name="qty[]" min="1"
                                        value="1" required onkeyup="inputChange(1)">
                                </td>
                                <td>
                                    <select name="ketarangan_status[]" class="form-select ketStatus-1"
                                        aria-label="Select example" onchange="selectChange(1)">
                                ...
                                <td>
                                    <button type="button" class="btn btn-light-primary font-weight-bold addRow">+</button>
                                </td>
                            </tr>
                        </tbody>
                        <!--end::Table body-->
            ...
            html = `
                <tr>
                    <td><input type="number" class="form-control text-center qtyTotal-` + row + `" name="qty[]" min="1"
                            value="1" required onkeyup="inputChange(` + row + `)">
                    </td>
                    <td>
                        <select class="form-select ketStatus-` + row + `" aria-label="Select example" onchange="` +
                selectChange(row) + `">
                            <option>Open this select keterangan</option>
                            <option value="tepat_waktu">Tepat Waktu</option>
                            <option value="terlambat">Terlambat / ({{ $denda }})</option>
                    ...
                    <td>
                        <input type="text" class="form-control text-center denda-` + row + `" name="" id="">
                    </td>
                    <td>
                        <button type="button" class="btn btn-light-danger font-weight-bold removeRow">-</button>
                    </td>
                </tr>
            `
