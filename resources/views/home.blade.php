                                ...
                                <div class="d-flex flex-stack flex-wrap">
                                    ...
                                    <div class="d-flex align-items-center pe-2">
                                        ...
                                        <div class="fs-5 fw-bolder">
                                            <a href="../../demo9/dist/pages/profile/overview.html" class="text-gray-700 text-hover-primary">David Morgan</a>
                            ...
                            <div class="ps-lg-6 mb-16 mt-md-0 mt-17">
                                ...
                                <div class="d-flex flex-stack flex-wrap">
                                    ...
                                    <div class="d-flex align-items-center pe-2">
                                        ...
                                        <!--begin::Text-->
                                        <div class="fs-5 fw-bolder">
                                            <a href="../../demo9/dist/pages/profile/overview.html" class="text-gray-700 text-hover-primary">Jane Miller</a>
                                            <span class="text-muted">on Apr 27 2021</span>
                                        </div>
                                        <!--end::Text-->
                                    </div>
                            ...
                            <div class="ps-lg-6 mb-16">
                                ...
                                <div class="d-flex flex-stack flex-wrap">
                                    ...
                                    <div class="d-flex align-items-center pe-2">
                                        ...
                                        <!--begin::Text-->
                                        <div class="fs-5 fw-bolder">
                                            <a href="../../demo9/dist/pages/profile/overview.html" class="text-gray-700 text-hover-primary">Cris Morgan</a>
                    ...
                    <div class="row g-10">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch me-md-6">
                                ...
                                <div class="m-0">
                                    <!--begin::Title-->
                                    <a href="../../demo9/dist/pages/profile/overview.html" class="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">Metronic Admin - How To Started the Dashboard Tutorial</a>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch ms-md-6">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="fs-6 fw-bolder">
                                        <!--begin::Author-->
                                        <a href="../../demo9/dist/pages/profile/overview.html" class="text-gray-700 text-hover-primary">Carles Nilson</a>
                                        <!--end::Author-->
                                        <!--begin::Date-->
