                ...
                <div class="card-body">
                    <div class="p-10">
                        ...
                        <div class="text-center">
                            ...
                            <img class="w-150px ms-n1 pt-4" src="data:image/png;base64, {!! base64_encode(
                                QrCode::size(200)->format('png')->merge('http://www.smkn1sakra.sch.id/media_library/images/b62182c38fc2ed8c58be78f1fe97a025.png', 0.3, true)->generate(route('admin.peminjaman.show', $peminjaman->is_code)),
                            ) !!} ">
                            <br>
                            <div class="pt-4">
                                <strong>
                            ...
                            <div class="pt-4">
                                <strong>
                                    ...
                                    <span class="fs-2hx fw-bolder text-dark me-2 lh-1"
                                        style="font-size: 15">{{ ucwords($peminjaman->is_status) }}</span>
                                </strong>
                            </div>
                            @if ($peminjaman->is_status === 'pending')
